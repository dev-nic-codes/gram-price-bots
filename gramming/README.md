...
Standalone Telegram price publisher and trade-alert bot for GRAMMING. The public default channel is `@grammingprices`; trade alerts are read from the configured DeDust pool.
