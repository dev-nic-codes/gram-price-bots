...
Standalone Telegram price publisher and trade-alert bot for REDO. The public default channel is `@redopricess`; trade alerts are read from the configured STON.fi pool.
