...
Standalone Telegram price publisher and trade-alert bot for UTYA. The public default channel is `@utyaprices`; trade alerts are read from the configured STON.fi pool.
