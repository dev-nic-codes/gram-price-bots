...
Standalone Telegram price publisher and trade-alert bot for GROYP. The public default channel is `@groypprices`; trade alerts are read from the configured STON.fi pool.
