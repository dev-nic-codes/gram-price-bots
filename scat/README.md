...
Standalone Telegram price publisher and trade-alert bot for SCAT. The public default channel is `@ScaredCatsPrice`; trade alerts are read from the configured STON.fi pool.
