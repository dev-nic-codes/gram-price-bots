...
Standalone Telegram price publisher and trade-alert bot for CHERRY. The public default channel is `@cherryprices`; trade alerts are read from the configured STON.fi pool.
