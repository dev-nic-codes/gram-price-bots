...
Standalone Telegram price publisher and trade-alert bot for MTONGA. The public default channel is `@mtongaprices`; trade alerts are read from the configured DeDust pool.
