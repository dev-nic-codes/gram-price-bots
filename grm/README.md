...
Standalone Telegram price publisher and trade-alert bot for GRM. The public default channel is `@GRM_prices`; trade alerts are read from the configured STON.fi pool.
